...
# MAGIC %md
# MAGIC # Supplementary Examples on HuggingFace - CPU Edition
...
# MAGIC
# MAGIC All code here is tested on MLR 13.2 on a i3.4xlarge instance
# MAGIC We suggest gpu nodes generally
# MAGIC ----
# MAGIC **Notes**
...
# for cpu we need extra libraries
...
# DBTITLE 1,Load CPU Weights
%sh wget -P /local_disk0/ https://huggingface.co/TheBloke/Wizard-Vicuna-13B-Uncensored-SuperHOT-8K-GGML/resolve/main/wizard-vicuna-13b-uncensored-superhot-8k.ggmlv3.q2_K.bin
...
model_id = '/local_disk0/wizard-vicuna-13b-uncensored-superhot-8k.ggmlv3.q2_K.bin'
